window.onload = function() {
  ...
  //var etiquetaRecuperarContrasena = document.getElementById("idRecuperarContrasena");
  
  
  /*etiquetaRecuperarContrasena.onclick = function(e) {
    e.preventDefault();
    if (validarUsuario(campoUsuario[0]) == false) {
      return;
    }
    alert("Se presionó la etiquetaRecuperarContrasena heydi y armando");
    //window.location = "php/recuperarPassword.php?usuario="+campoUsuario[0].value;
  }
  */
