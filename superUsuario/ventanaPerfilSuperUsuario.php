        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="row">
                <form id = "idFormularioModalModificarPerfilSuperUsuario">
                  <div class="form-group">
                    <label for="" style="text-align:left" class="col-sm-4 control-label">Usuario:
                    </label>
                    <div class="col-sm-8">                    
                      <input type="text" class="form-control" name="campoUsuario"  placeholder="" required  id="idCampoUsuarioFormularioModal" readonly="true">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="" style="text-align:left" class="col-sm-4 control-label">Nombre:</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="campoNombre" placeholder="" required id="idCampoNombreFormularioModal">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="" style="text-align:left" class="col-sm-4 control-label">Apellido:</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="campoApellido"  placeholder="" required id="idCampoApellidoFormularioModal">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="" style="text-align:left" class="col-sm-4 control-label">Contraseña:</label>
                    <div class="col-sm-8">
                      <input type="password" class="form-control" name="campoContrasena1"  placeholder="" required id="idCampoContrasena1FormularioModal">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="" style="text-align:left" class="col-sm-4 control-label">Repetir Contraseña:</label>
                    <div class="col-sm-8">
                      <input type="password" class="form-control" name="campoContrasena2"  placeholder="" required id="idCampoContrasena2FormularioModal">
                    </div>
                  </div>                
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="campoCorreo"  required id="idCampoCorreoFormularioModal">
                    </div>
                  </div>                
                </form>                
              </div>
